...
namespace PruebaTecnicaService.Security
{
    /// <summary>
    ...
    {
        public static string GenerateTokenJwt(string username, string rolname, string sessionId)
        {
        ...
        public static string GenerateTokenJwt_up(string username, string rolname, string password)
        {
            //TODO: appsetting for Demo JWT - protect correctly this settings
            var secretKey = ConfigurationManager.AppSettings["JWT_SECRET_KEY"];
            var audienceToken = ConfigurationManager.AppSettings["JWT_AUDIENCE_TOKEN"];
